...
public class EsaudeReportInitializer implements Initializer {
	...
	// String report_resource_quality_improvement_id = "select id from
	// reporting_report_design where
	// uuid='c200541e-72ce-11e7-b45c-507b9dc4c741'";
	// //deleting the resource already loaded
	// as.executeSQL("delete from reporting_report_design_resource where
	// report_design_id =("
	// + report_resource_quality_improvement_id + ");", false);
	// //deleting the actual designs now
	// as.executeSQL("delete from reporting_report_design where
	// uuid='c200541e-72ce-11e7-b45c-507b9dc4c741';", false);
	//
	// //deleting all report requests and managers
	// as.executeSQL("delete from reporting_report_request;", false);
	// as.executeSQL("delete from global_property WHERE property LIKE
	// 'reporting.reportManager%';", false);
	//
	// //deleting the actual report definitions from the db
	// as.executeSQL("delete from serialized_object WHERE uuid =
	// 'd1275b54-72ce-11e7-8b29-507b9dc4c741';", false);
	// }
	...
	// deleting MMIA Report for develpment enviroments
